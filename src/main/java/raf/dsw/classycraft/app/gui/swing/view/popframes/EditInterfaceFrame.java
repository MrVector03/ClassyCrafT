...
public class EditInterfaceFrame extends JFrame {
    ...
    public EditInterfaceFrame() {
        ...
        JLabel eicAccesLabel = new JLabel("New interface access:");
        ...
        JLabel eicLabel = new JLabel("New interface name:");
        eicLabel.setAlignmentX((float)0.5);

        eicTextField = new JTextField();
        eicTextField.setAlignmentX((float)0.5);

        JLabel eicCContentLabel = new JLabel("New interface methods:");
        eicCContentLabel.setAlignmentX((float)0.5);

        eicTextArea = new JTextArea();

        JButton caButton = new JButton();
        caButton.setAction(MainFrame.getInstance().getActionManager().getInterfaceEditConfirmAction());

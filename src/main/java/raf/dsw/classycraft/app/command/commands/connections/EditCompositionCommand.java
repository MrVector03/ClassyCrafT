...
public class EditCompositionCommand extends AbstractCommand {
    ...
    private Composition curCon;
    private DiagramView curDiagramView;

    public EditCompositionCommand(String oldConName, String oldConVar, char oldConCardFrom, char oldConCardTo, String newConName, String newConVar, char newConCardFrom, char newConCardTo, Composition curCon, DiagramView curDiagramView) {

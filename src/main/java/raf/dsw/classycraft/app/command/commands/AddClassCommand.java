...
public class AddClassCommand extends AbstractCommand {
    ...
    public void doCommand() {
        ...
        curDiagram.addDiagramElementPainter(painterManufacturer.createPainter(newClass));
    }

    @Override
    public void undoCommand() {
        DiagramElementPainter depToRemove = null;

        for (DiagramElementPainter dep : curDiagram.getDiagramElementPainters())
            if (dep.getDiagramElement().equals(newClass))
                depToRemove = dep;

        curDiagram.getDiagramElementPainters().remove(depToRemove);
        curDiagram.getDiagram().deleteChild(depToRemove.getDiagramElement());

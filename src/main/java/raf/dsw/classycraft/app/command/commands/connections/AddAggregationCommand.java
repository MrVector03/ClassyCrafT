...
public class AddAggregationCommand extends AbstractCommand {
    ...
    public AddAggregationCommand(String newConName, String newConVar, char newConCardFrom, char newConCardTo, InterClass newConFrom, InterClass newConTo, DiagramView curDiagramView) {
        ...
        curDep = painterManufacturer.createPainter(newAggregation);
    }
